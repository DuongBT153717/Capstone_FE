          ...
          <Box height="100%" display="flex">
            ...
            <Box flex="4">
              ...
              <Box style={{ display: 'flex', flexDirection: 'column' }}>
                {
                currentUser?.role === 'hr' || currentUser?.role === 'admin' || currentUser?.role === 'security' ?
                request[0]?.requestMessageResponse?.requestTicketStatus != 'CLOSED' &&
                request[0]?.requestMessageResponse?.receiverId === currentUser?.accountId ? (
                  ...
                  <></>
                ): request[0]?.requestMessageResponse?.requestTicketStatus != 'CLOSED' ? <CKEditor
                editor={ClassicEditor}
                onChange={(event, editor) => {
                  const data = editor.getData()
                  setContent(data)
              ...
              />: <></>
                ...
                request[0]?.requestMessageResponse?.receiverId === currentUser?.accountId ? (
                  ...
                  <></>
                ): request[0]?.requestMessageResponse?.requestTicketStatus != 'CLOSED' ? <Button
                sx={{ mr: 2 }}
