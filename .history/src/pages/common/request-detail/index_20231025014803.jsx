...
import RejectFormModal from './components/RejectFormModal'
    ...
    <>
      {request.length === 0 ? (
        ...
        <Box>
                        ...
                        {index === 0 ? (
                          <StyledPaper>
                            ...
                            <Box display="flex" gap="10px" justifyContent="flex-end">
                              <Button onClick={() => setOpen(true)} variant="contained" sx={{ bgcolor: 'red' }}>
                                Reject
                              </Button>
          ...
          <RejectFormModal open={open} setOpen={setOpen} />
        </Box>
