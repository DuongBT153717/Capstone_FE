...
const NotificationDetail = () => {
  ...
  const handleDownload = () => {
    const blob = new Blob(['Your file content'], { type: 'application/vnd.openxmlformats-officedocument.wordprocessingml.document' })
    ...
    <Box bgcolor={theme.palette.bgColorPrimary.main}>
      ...
      <Paper sx={{ padding: 2, m: 2 }}>
        ...
        <Box mt={2}>
          ...
          {
            notificationDetail?.notificationFiles !== null && notificationDetail?.notificationFiles.length > 0 &&
