  ...
  return (
    <Box bgcolor={theme.palette.bgColorPrimary.main}>
      ...
      <Paper sx={{ padding: 2, m: 2 }}>
        ...
        <Divider />
        <Box mt={2} maxHeight="50px">
          <Typography
            >Lorem ipsum dolor sit amet consectetur adipisicing elit. Vel maiores nesciunt aliquam sint quae sequi nulla est expedita iusto quisquam, velit fugit blanditiis temporibus quos similique tenetur ratione dolor id?Lorem ipsum dolor sit amet consectetur adipisicing elit. Et, numquam aliquid, veritatis laborum facere repellat aut quia veniam at, enim cupiditate repudiandae odio cum! Exercitationem suscipit atque ea quos qui!LoremLorem ipsum dolor sit amet consectetur adipisicing elit. Vel maiores nesciunt aliquam sint quae sequi nulla est expedita iusto quisquam, velit fugit blanditiis temporibus quos similique tenetur ratione dolor id?Lorem ipsum dolor sit amet consectetur adipisicing elit. Et, numquam aliquid, veritatis laborum facere repellat aut quia veniam at, enim cupiditate repudiandae odio cum! Exercitationem suscipit atque ea quos qui!Lorem</Typography>
        </Box>
        <Divider />
        <Box mt={2}>
