...
const AttendenceFrom = ({ userId }) => {
  const [from, setFrom] = useState(dayjs('13:00'))
  ...
  const handleCreateRequest = (e) => {
    ...
    if (role == 'manager') {
      let data = {
        ...
        title: title,
        content: content,
        manualDate: from.format('DD-MM-YYYY'),
        manualFirstEntry: from.format('HH:mm'),
        manualLastExit: to.format('HH:mm'),
      ...
      let data = {
        ...
        title: title,
        content: content,
        manualDate: from.format('YYYY-dd-MM'),
        manualFirstEntry: from.format('HH:mm'),
        manualLastExit: to.format('HH:mm'),
