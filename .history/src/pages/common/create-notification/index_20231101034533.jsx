...
const CreateNotification = () => {
  ...
  const handleChangeDepartment = (event) => {
    ...
    if (checked) {
      ...
      console.log(updatedDepartmentId);
    ...
    const filteredUser = users.filter((user) => updatedDepartmentId.includes(user.departmentId).map((user) => user.accountId))
    const updateFilteredUser = filteredUser.map((item) => {
      return item.accountId
    })
    setSelectedUsers(updateFilteredUser);
