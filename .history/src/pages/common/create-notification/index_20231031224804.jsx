...
const CreateNotification = () => {
  ...
  useEffect(() => {
  // Update the defaultValue whenever filteredUsers changes
  if (filteredUsers.length > 0) {
    const selectedUserIds = selectedUsers.map((userId) => users.find((user) => user.accountId === userId));
    // Set the selected users as the defaultValue
    setDefaultValue(selectedUserIds);
  }
