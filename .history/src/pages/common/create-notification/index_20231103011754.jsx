...
const CreateNotification = () => {
  ...
  const handleChangeDepartment = (event) => {
    ...
    if (checked) {
      ...
      setUpdateFilteredUsers((prevUpdateFilteredUsers) => prevUpdateFilteredUsers.filter((user) => user.departmentId !== name));
      setSelectedUsers((prevUpdateFilteredUsers) => prevUpdateFilteredUsers.filter((user) => user.departmentId !== name));
    }
