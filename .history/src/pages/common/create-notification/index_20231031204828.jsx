...
const CreateNotification = () => {
  ...
  const handleAutocompleteChange = (event, newValue) => {
    setSelectedDepartmentIds(newValue.map((option) => option.departmentId))
  }
  ...
  const handleChangeDepartment = (event) => {
    ...
    if (checked) {
      setDepartmentId((prevIds) => [...prevIds, name])
    } else {
      setDepartmentId((prevIds) => prevIds.filter((id) => id !== name))
    }

    const filteredUser = users.filter((user) => selectedDepartmentIds.includes(user.departmentId))
