                    ...
                    <Grid item container spacing={3}>
                      ...
                      <Typography mb={2}>Attach file: </Typography>
                        <TextField
                          ...
                          sx={{display: 'none'}}
                        />
                        <label htmlFor="customFileInput" id="customFileLabel" style={{padding: '10px', backgroundColor: 'yellow', borderRadius:'5px', margin: '0px', cursor: 'pointer'}}>Choose file</label>
                        <TextField
                          id="customInput"
                          fullWidth
                          type="file"
                          sx={{display: 'none'}}
                        />
                        <label htmlFor="customInput" id="customFileLabel" style={{padding: '10px', backgroundColor: 'red', borderRadius:'5px', marginLeft: '10px', cursor: 'pointer'}}>Choose Image</label>
                      </Grid>
                      <Grid display='flex' alignItems='center' gap='10px' item xs={5}>
