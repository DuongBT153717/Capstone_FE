...
const CreateNotification = () => {
  ...
  const handleChangeDepartment = (event) => {
    ...
    if (checked) {
      ...
      setSelectedUsers((prevSelectedUsers) => [...prevSelectedUsers, ...updateFilteredUser]);
      setUpdateFilteredUsers((prevSelectedUsers) => [...prevSelectedUsers, ...filteredSelectedUser])
    } else {
