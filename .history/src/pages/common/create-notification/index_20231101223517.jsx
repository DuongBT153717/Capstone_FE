...
const CreateNotification = () => {
  ...
  const handleChangeDepartment = (event) => {
    ...
    if (checked) {
      ...
      setSelectedUsers((prevSelectedUsers) => [...new Set([...prevSelectedUsers, ...updateFilteredUser])]);
      setUpdateFilteredUsers((prevUpdateFilteredUsers) => [...new Set([...prevUpdateFilteredUsers, ...filteredSelectedUser])]);
    } else {
