...
const users = [
  { userId: '1', userName: 'User 1', departmentId: '1' },
  { userId: '2', userName: 'User 2', departmentId: '2' },
  { userId: '3', userName: 'User 3', departmentId: '2' },
  { userId: '4', userName: 'User 4', departmentId: '2' },
  { userId: '5', userName: 'User 5', departmentId: '2' },
  { userId: '6', userName: 'User 6', departmentId: '3' },
  { userId: '7', userName: 'User 1', departmentId: '1' },
  { userId: '8', userName: 'User 2', departmentId: '2' },
  { userId: '9', userName: 'User 3', departmentId: '2' },
  { userId: '10', userName: 'User 4', departmentId: '2' },
  { userId: '11', userName: 'User 5', departmentId: '2' },
  { userId: '12', userName: 'User 6', departmentId: '3' },
  { userId: '13', userName: 'User 1', departmentId: '1' },
  { userId: '2', userName: 'User 2', departmentId: '2' },
  { userId: '3', userName: 'User 3', departmentId: '2' },
  { userId: '4', userName: 'User 4', departmentId: '2' },
  { userId: '5', userName: 'User 5', departmentId: '2' },
...
const CreateNotification = () => {
  ...
  const handleAutocompleteChange = (event, newValue) => {
    setSelectedDepartmentIds(newValue.map((option) => option.userId))
  }
