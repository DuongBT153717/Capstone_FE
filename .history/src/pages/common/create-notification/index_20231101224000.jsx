...
const CreateNotification = () => {
  ...
  const handleCreateNotification = (e) => {
    ...
    if (state.button === 2) {
      ...
      const data = {
        buttonStatus: 'upload',
        userId: 'fd53f8ab-941f-4380-81af-684e0874dcc4',
        title: 'sang',
        sendAllStatus: false,
        receiverId: [
          '68afe34e-1eeb-4288-aeff-64296b5fe00d',
          '6ed6c535-3b41-4105-905b-bc7456dc46d1'
        ],
        priority: true,
        content: 'sang',
        uploadDatePlan: '2023-10-31 22:40:00'
      }
    }
  }
  return (
    <Box bgcolor={theme.palette.bgColorPrimary.main}>
      ...
      <Box
        ...
        <Grid container>
          <Grid item xs={12}>
            <form autoComplete="off" noValidate onSubmit={handleCreateNotification}>
              <Card>
                <CardContent>
