...
const Profile = () => {
  ...
  useEffect(() => {
    ...
    setCountryUpdate(userInfo?.lastName)
  ...
  const handleSubmit = () => {
    if(userInfo?.firstName === 'unknown' && userInfo?.lastName === 'unknown' && userInfo?.gender === 'unknown' && userInfo?.city === 'unknown' && userInfo?.dateOfBirth === 'unknown' && userInfo?.country === 'unknown' && userInfo?.email === 'unknown' && userInfo?.telephoneNumber === 'unknown' && userInfo?.image === 'unknown'){
