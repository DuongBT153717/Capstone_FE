          ...
          <Grid item container spacing={3}>
            ...
            <Grid item xs={12} md={6}>
              <TextField
                fullWidth
                label="Last name"
                value={props.userInfo.setLastName}
            ...
            <Grid item xs={12} md={6}>
                <LocalizationProvider dateAdapter={AdapterDayjs}>
                  <DatePicker
                    label="Date of birth"
                    value={props.userInfo.dateOfBirth}
            ...
            <Grid item xs={12} md={6}>
              <TextField
                ...
                name="country"
                onChange={(e) => props.setCountry(e.target.value)}></TextField>
            </Grid>
            <Grid item xs={12} md={6}>
              <TextField
                fullWidth
                ...
                name="city"
                onChange={(e) => props.setCity(e.target.value)}></TextField>
            </Grid>
            <Grid item xs={12} md={6}>
