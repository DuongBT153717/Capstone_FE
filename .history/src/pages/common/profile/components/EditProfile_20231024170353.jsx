          ...
          <Grid item container spacing={3}>
            <Grid item xs={12} md={6}>
              <TextField
                fullWidth
                value={
                  props.userInfo?.firstName !== 'unknown' ? props.firstNameUpdate : props.firstName
                }
                label="First name"
                onChange={
                ...
                <DatePicker
                  ...
                  value={
                    props.userInfo.dateOfBirth !== 'unknown'
                      ? props.birthUpdate.split('/').reverse().join('-')
                      : props.birth
                  }
                  onChange={
                    props.userInfo.dateOfBirth !== 'unknown'
                      ? (e) => props.setBirthUpdate(e.target.value)
                      : (e) => props.setBirth(e.target.value)
                  }
