...
const EditProfile = (props) => {
  ...
  console.log(props.userInfo.dateOfBirth.replaceAll('/','-'));
  props.setBirth(props.userInfo?.dateOfBirth.split("/").reverse().join("-"))
  return (
    <>
      <CardContent>
        <Box sx={{ mb: 1 }}>
          <Grid item container spacing={3}>
            ...
            <Grid item xs={12} md={6}>
                <LocalizationProvider dateAdapter={AdapterDayjs}>
                  <DatePicker
                    label="Date of birth"
                    value={props.userInfo?.dateOfBirth ? props.userInfo?.dateOfBirth.split("/").reverse().join("-") : props.birth}
