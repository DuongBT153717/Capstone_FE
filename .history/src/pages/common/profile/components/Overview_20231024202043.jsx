  ...
  return (
    <>
      ...
      <CardActions sx={{ justifyContent: 'flex-start' }}>
        {
          currentUser?.role === 'hr' ? <Link to="/manage-user">
          <Button variant="contained" sx={{ bgcolor: 'rgb(100, 149, 237)' }}>
            Back to Dashboard
          </Button>
        </Link> : currentUser?.role === 'employee' ? <Link to="/manage-user">
          <Button variant="contained" sx={{ bgcolor: 'rgb(100, 149, 237)' }}>
            Back to Dashboard
          </Button>
        </Link> : currentUser?.role === 'manager' ? <Link to="/request-list-manager">
          <Button variant="contained" sx={{ bgcolor: 'rgb(100, 149, 237)' }}>
            Back to Dashboard
          </Button>
        </Link> : currentUser?.role === 'admin' ? <Link to="/request-list-admin">
          <Button variant="contained" sx={{ bgcolor: 'rgb(100, 149, 237)' }}>
            Back to Dashboard
          </Button>
        </Link> : currentUser?.role === 'security' ? <Link to="/manage-user">
          <Button variant="contained" sx={{ bgcolor: 'rgb(100, 149, 237)' }}>
            Back to Dashboard
          </Button>
        </Link> : <></>
