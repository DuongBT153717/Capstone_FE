    ...
    <AppointmentTooltip.Content {...restProps} appointmentData={appointmentData}>
      <Grid mt={1} container alignItems="center">
        <Grid display="flex" gap='8px' ml="25px" item xs={10}>
          ...
          <Typography color={appointmentData.bookingStatus === 'ACCEPTED' ? 'green': 'yellow'}>{appointmentData.bookingStatus}</Typography>
        </Grid>
      </Grid>
...
const data1 = [
  {
    ...
    startDate: '2023-11-03 14:00:52',
    endDate: '2023-11-03 15:00:52',
    id: '0',
    roomId: 1
  },
  {
